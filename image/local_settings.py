...
HORIZON_CONFIG = {
    ...
    'help_url': "https://help.switch.ch/engines",
...
# for all of them.
# from horizon.utils import secret_key
SECRET_KEY = secret_key.generate_or_read_from_file("/etc/openstack-dashboard/secret/.secret_key_store")
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://%REDIS_MASTER_SERVICE_HOST%:6379/1",
        "OPTIONS": {
...
# Only default theme made available
# See https://docs.openstack.org/developer/horizon/topics/customizing.html
AVAILABLE_THEMES = [
...
FILE_UPLOAD_TEMP_DIR = '/var/lib/horizon/upload'



# Customized HTML title, which appears at the top of the browser window
SITE_BRANDING = 'SWITCHengines'

##
# SWITCH Horizon quickstart UI
##
#
# The DATABASES must be define in local_settings.py
#
# If EXPIRATION_ENABLED = True # a database configuration is required:
...
EMAIL_USE_TLS = True
EMAIL_HOST = 'mailgateway.unil.cloud.switch.ch'
EMAIL_PORT = 587
EMAIL_HOST_USER = ''
EMAIL_HOST_PASSWORD = ''
DEFAULT_FROM_EMAIL = 'engines-support@switch.ch'
